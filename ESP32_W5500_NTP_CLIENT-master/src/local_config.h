 ...
 */
IPAddress eth_IP(192, 168, 178, 100);		// *** CHANGE THIS to something relevant for YOUR LAN. ***
IPAddress eth_MASK(255, 255, 255, 0);		// Subnet mask.
IPAddress eth_DNS(192, 168, 178, 2);		// *** CHANGE THIS to match YOUR DNS server.           ***
IPAddress eth_GW(192, 168, 178, 1);		// *** CHANGE THIS to match YOUR Gateway (router).     ***
